...
public class LoginDao {
	public String authenticateUser(LoginBean loginBean) {
		...
		try {
			...
			resultSet = statement.executeQuery("select * from users where(username='" + userName + "'&&password='"
					+ password + "'&&type='admin')"); // Here table name is users and userName,password are columns.
