	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			while (rs.next()) {
				...
				output = output
						+ "<th>Date</th><th>Booking Id</th><th>Entry Time</th><th>Vehicle Type</th><th>Registration Number</th><th>Contact Number</th><th>Name</th>";
				output = output + "<tr>";
				...
				output = output + "<td>" + B_date + "</td><td>" + B_id + "</td><td>" + B_actEntry + "</td><td>"
						+ B_vehicleType + "</td><td>" + RegNo + "</td><td>" + contact + "</td><td>" + Name + "</td>";
				output = output + "</tr>";
			}
			output = output + "</table>";
			rs.close();
