		...
		<div class="content clearfix">
			...
			<form action="Registration" method="post">
				...
				<div class="login-fields">
					...
					<div class="field">
						<label class="radio-inline radio-fields"> <input
							class="input-radio-fields" type="radio" name="loginType"
							value="owner" checked>Parking Owner

						</label> <label class="radio-inline radio-fields"> <input
							class="input-radio-fields" type="radio" name="loginType"
					...
					<div class="field">
						<label for="number">Contact Number</label> <input type="number"
							...
							class="login username-field" min="1111111111" max="9999999999"
							required />
					</div>
				...
				<div class="login-actions">
					<a href="home.jsp" style="float: left;" class="">Have an
						account?</a>
