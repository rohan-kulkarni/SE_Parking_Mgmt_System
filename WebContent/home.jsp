								...
								<form action="HomeLogin" method="post">
									...
									<div class="login-fields">
										...
										<div class="field">
											...
											<input type="text" id="username" name="username" value=""
												placeholder="Enter Username" class="login username-field"
												style="width: 305px;" />
										</div>
										<!-- /field -->
										...
										<div class="field">
											...
											<input type="password" id="password" name="password" value=""
												placeholder="Enter Password" class="login password-field" />
										</div>
										<!-- /password -->
										<div class="field">
											<label for="loginType" style="color: white;">User
												Type:</label> <select id="loginType" name="loginType"
												class="select-input">
									...
									<div class="login-actions">
										...
										<button class="btn btn-group-justified btn-large button"
											style="background-color: #1d3c50; color: white;">Sign
											In</button>
										<br /> <br />
